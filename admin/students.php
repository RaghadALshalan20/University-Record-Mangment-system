...
$per_page=10;
		...
		$sql="SELECT students_info.id as id,students_info.name as name, students_info.mobile as mobile, students_info.blocked as status, department.name as dept FROM
		students_info
...
_END;
	...
	echo '<th>option</th><th>NAME</th><th>DEPARTMENT</th><th>TELEPHONE</th><th>Status</th></tr></thead>';
	$i= $start;
	//for ($i = $start; $i < $end; $i++)
